...
export const AdminLayout: React.FC = () => {
  ...
  if (organizations.length === 0) {
    return (
      <div className="flex items-center justify-center h-screen bg-background text-foreground">
        <div className="text-center max-w-md p-8 rounded-xl border border-border bg-card text-card-foreground">
  ...
  return (
    <div className="flex h-screen bg-background text-foreground">
      {/* Sidebar */}
      <div className="w-16 bg-background border-r border-border flex flex-col items-center py-4 space-y-6">
        {/* Logo */}
        <div className="flex items-center justify-center w-10 h-10 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-colors">
        ...
        <div className="flex flex-col items-center space-y-3 pb-2">
          {/* User Avatar */}
          <div
            className="w-10 h-10 flex items-center justify-center rounded-lg bg-accent text-accent-foreground border border-border font-semibold text-sm"
            title={userEmail}
          >
          ...
          <button
            onClick={handleSignOut}
            className="w-10 h-10 flex items-center justify-center rounded-lg text-muted-foreground hover:bg-red-600/20 hover:text-red-400 transition-all duration-200 group"
            title="Sign Out"
          >
